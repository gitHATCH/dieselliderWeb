...
const ModalVerify = () => {
    const {deleteProducts} = useContext(OrderContext);
    ...
    >
        <Fade in={modalVerify}>
            <Box sx={style} className="rounded-xl bg-black">
                ...
                <div className=''>
                    <CancelIcon className='text-red-700 hover:cursor-pointer hover:text-red-500' onClick={handleModalVerify} style={{fontSize:25}}/>
                </div>
                </div>
            </Box>
        </Fade>
